...
_pa.segments = [{"name":"All visitors","id":797706,"regex":".*"},{"name":"Dashboard","id":797717,"regex":"/apps/?([?#].*)*$"},{"name":"Submitted Email","id":797764,"regex":"/account/?([?#].*)*$"},{"name":"Confirmed Account","id":797769,"regex":"/account/accept/.*/?([?#].*)*$"},{"name":"Connect","id":1682533,"regex":"/connect/?([?#].*)*$"},{"name":"Devcenter PHP","id":1692138,"regex":"/categories/php.*/?([?#].*)*$"},{"name":"DX Demo Confirmation Page","id":2412129,"regex":"/Heroku_DX_demo/?([?#].*)*$"},{"name":"XL Contact Us Submission","id":1511601,"regex":"/contact/thanks/?([?#].*)*$"},{"name":"Contact Us - Thank You Page","id":1682534,"regex":"/thanks/?([?#].*)*$"},{"name":"XL","id":1511600,"regex":"/xl/?([?#].*)*$"},{"name":"PHP Page","id":1810322,"regex":"/php/?([?#].*)*$"},{"name":"Welcome Heroku","id":2882649,"regex":"signup.heroku.com/account/accept/ok"}];
_pa.conversions = [{"name":"Heroku XL Sign Up","id":"163522","regex":"/contact/thanks/?([?#].*)*$"},{"name":"Contact Us - Thank You","id":"185740","regex":"/thanks/?([?#].*)*$"},{"name":"https://id.heroku.com/account","id":"165810","regex":"id\\.heroku\\.com\\/account"},{"name":"DX Conversion","id":"488220","regex":"/Heroku_DX_demo/?([?#].*)*$"},{"name":"DX Conversion","id":"488797","regex":"/Heroku_DX_demo/?([?#].*)*$"},{"name":"Landing Page Hit","id":"501826","regex":"start\\.heroku\\.com"},{"name":"PHP Sign Up","id":"200540","regex":"start\\.heroku\\.com\\/account"},{"name":"Welcome Heroku Screen","id":"538461","regex":"signup.heroku.com/account/accept/ok"},{"name":"https://signup.heroku.com/account","id":"274004","regex":"signup\\.heroku\\.com\\/account"},{"name":"Signed Up ***Pixel #83564***","id":"83564","regex":"pixel"}];
_pa.conversionEvents = [];
_pa.segmentEvents = [];
_pa.thirdPartyTags = [];
_pa.thirdPartyTagEvents = [];
_pa.allVisitorsSegmentId = 797706;
_pa.clickThroughWindow = 30;
_pa.viewThroughWindow = 7;
_pa.rtbId = '12089';
_pa.siteId = '51b6483a434bba0f0c000016';
